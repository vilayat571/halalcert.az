    ...
    py-12 mt-8"
      >
        ...
        <p className=" text-[#585656] text-base tracking-wider px-2">
          ...
          “Halal” məhsullarının Sertifikatlaşdırılması Orqanı kimi nəzərdə
          tutulan bu orqanın əsas məqsədi{" "}
          <i>AZS OIC/SMIIC 1:2022 (OIC/SMIIC 1:2019)</i> “Halal qida üçün ümumi
          tələblər” və <i>AZS OIC/SMIIC 2:2022</i> “Uyğunluğun
          qiymətləndirilməsi – halal sertifikatlaşdırmanı həyata keçirən
          orqanlar üçün tələblər” standartlarının tələblərinə uyğun fəaliyyət
          göstərməkdir.
          <br />
          <br />
          “AzeSERT HALAL” {" "}
          ...
          <i>
            ...
            halal sertifikatlaşdırmanı həyata keçirən orqanlar üçün tələblər”
          </i>
